...
- [x] Complete a distribution provenance ledger and resolve unverified third-party licensing. `[truth:source-audit]` `[truth:deferred]`
  ...
  - Completion proof: `docs/PROVENANCE_LEDGER.csv` passes `tools/generate_provenance_ledger.py --check --strict` with 257 cleared and 0 unverified rows, including 39 original Breakwater assets.
